    ...
    this.map = new Map({
      layers: [
        new TileLayer({
          source: new OSM({
            attributions: [
              'Copyright &copy <a href="https://pulse.sn" target="_blank">Pulse Sn</a> - <a href="https://api.whatsapp.com/send?phone=694698607&text=" target="_blank">GeOsm Family</a> - <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>',
            ],
          }),
        }),
